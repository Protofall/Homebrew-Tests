...
typedef struct audio_info{
	...
	uint32_t size, freq;	// WIP. INCOMPLETE. Used to be of type ALsizei
	ALenum format;
...
// 0.5MB of buffer space
#define AUDIO_STREAMING_NUM_BUFFERS 16	// 4 is the bare minimum, but its safer to have more so you don't run out
#define AUDIO_STREAMING_DATA_CHUNK_SIZE (32 * 1024)	// 32KB is a good number
#define AUDIO_MAX_BUFFER_SIZE (64 * 1024) - 2	// ALdc has a max buffer size, 65534 samples
#define WAV_HDR_SIZE 44	// AKA the data offset
