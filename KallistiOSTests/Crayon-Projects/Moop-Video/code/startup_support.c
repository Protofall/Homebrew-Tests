...
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 1.25f;
  STARTUP_video_params.video_scale_multiplier = 1.0f / 1.25f;
...
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 40.0f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 40.0f;
...
// Framebuffer: 565x600
// Horizontal scale: 0.706x (really 27/38.25)
...
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 38.25f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 38.25f;
...
// Framebuffer: 425x768
// Horizontal scale: 0.415x (really 27/65)
// This one actually uses negative/negative polarity, too!
void STARTUP_1024x768_VGA(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 65.0f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 65.0f;
...
// Framebuffer: 380x864
// Horizontal scale: 0.330x (really 27/81.75)
void STARTUP_1152x864_VGA(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 81.75f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 81.75f;
...
// Framebuffer: 465x720
// Horizontal scale: 1/2.75x (exact)
void STARTUP_720p_VGA(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 2.75f;
  STARTUP_video_params.video_scale_multiplier = 1.0f / 2.75f;
...
// Framebuffer: 464x720
// Horizontal scale: 0.362x (really 27/74.5)
void STARTUP_1280x720_VGA(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 74.5f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 74.5f;
...
// Framebuffer: 414x800
// Horizontal scale: 0.323x (really 27/83.5)
void STARTUP_1280x800_VGA(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 83.5f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 83.5f;
...
// Framebuffer: 365x900
// Horizontal scale: 0.254x (really 27/106.5)
void STARTUP_1440x900_VGA(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 106.5f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 106.5f;
...
// Framebuffer: 548x480
// Horizontal scale: 0.857x (really 27/31.5)
void STARTUP_640x480_VGA_75(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 31.5f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 31.5f;
...
// Framebuffer: 436x600
// Horizontal scale: 0.545x (really 27/49.5)
void STARTUP_800x600_VGA_75(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 49.5f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 49.5f;
...
// Framebuffer: 352x768
// Horizontal scale: 0.343x (really 27/78.75)
void STARTUP_1024x768_VGA_75(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 78.75f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 78.75f;
...
// Framebuffer: 354x480
// Horizontal scale: 0.553x (really 27/48.75)
void STARTUP_640x480_VGA_120(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 48.75f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 48.75f;
...
// Framebuffer: 295x600
// Horizontal scale: 0.369x (really 27/73.25)
void STARTUP_800x600_VGA_120(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 73.25f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 73.25f;
...
// Framebuffer: 239x768
// Horizontal scale: 0.234x (really 27/115.5)
void STARTUP_1024x768_VGA_120(uint8_t fbuffer_color_mode)
{
  // Set global scale factors
  STARTUP_video_params.video_scale = 115.5f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 115.5f;
...
// Horizontal scale: 1x (well, ok, 27/27.561 (0.980x), but that's 16/832 pixels of stretch, or 2% per line)
// Framebuffer: 832x480
...
void STARTUP_848x480_VGA_CVT_RBv2(uint8_t fbuffer_color_mode)
{
  ...
  STARTUP_video_params.video_scale_multiplier = 1.0f;
#else
  STARTUP_video_params.video_scale = 27.561f / 27.0f;
  STARTUP_video_params.video_scale_multiplier = 27.0f / 27.561f;
#endif
